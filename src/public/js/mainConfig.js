...
function changeTypeChat() {
    $('#select-type-chat').bind('change', function () {
        ...
        console.log('select-type-chat');

        let optionSeleted = $('option:selected', this);
        optionSeleted.tab('show');

        if($(optionSeleted).data('target') === '#user-chat'){
            console.log('user-chat: hide');
